class CaseStudiesController < ApplicationController
  ...
  private
    ...
    def case_study_params
      params.require(:case_study).permit(:user_id, :placement_event_id, :project_name, :project_desc, :project_type_id, :project_type_other, :country, :region, :county, :city, :district_id, :saga_id, :survey_status_id, :survey_create_date, :survey_update_date, :project_area, :project_area_uom_id, :case_study_pk, :integer, :measurements, :latitude, :longitude, :editor_ids => [], :author_ids => [], :photos_attributes => [:id, :image, :_destroy] , :documents_attributes => [:id, :doc, :_destroy], :videos_attributes => [:id, :link, :title, :description, :tags, :_destroy])
    end
end
